...
class PLL_Admin_Filters_Post extends PLL_Admin_Filters_Post_Base {
	...
	public function add_meta_boxes( $post_type, $post ) {
		...
		if ( isset( $post->ID ) && ( $page_for_posts = get_option( 'page_for_posts' ) ) && ( $translations = $this->model->post->get_translations( $page_for_posts ) ) && in_array( $post->ID, $translations ) &&  empty( $post->post_content ) ) {
